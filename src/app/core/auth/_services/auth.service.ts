...
export class AuthService {
  ...
  getUserByToken(): Observable<User> {
    ...
    httpHeaders = httpHeaders.set('Authorization', 'Bearer ' + Cookie.get('access_token'));
      ...
      userInfo => {
        if(userInfo.token!=null||userInfo.token!="") {
          ...
          if(userInfo.userAccount.role=="ADMIN"){
            ...
            Cookie.set("access_token",userInfo.token);
            Cookie.set("user_id",userInfo.userAccount.id);
          }
